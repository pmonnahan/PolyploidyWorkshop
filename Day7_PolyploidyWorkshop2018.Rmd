...
msselCalc <- function(in_file, numWindows, slideRate=0.5, selPop=1, linkage_stats = c("Kelly.Z_nS"), neutrality_stats = c("Tajima.D", "Fay.Wu.H", "Zeng.E")){
  ...
  print(paste("Done", "Munging data..."), sep = "\n")
